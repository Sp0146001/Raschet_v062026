...
## Что ещё можно добавить следующим этапом

- сглаживание шумных каналов как опция;
- режим синхронного сравнения нескольких bar-line;
- нормализацию/фильтрацию перед расчётами;
- модульные тесты для парсера и формул.
